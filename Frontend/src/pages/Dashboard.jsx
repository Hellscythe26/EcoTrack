            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <h4 className="text-2xl font-bold text-gray-900">{proximosAVencer}</h4>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                ...
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <Link to="/inventario" className="flex flex-col items-center justify-center p-4 rounded-xl border border-green-100 bg-green-50 text-green-700 hover:bg-green-100 transition-all group">
                        ...
                        <button className="flex flex-col items-center justify-center p-4 rounded-xl border border-red-100 bg-red-50 text-red-700 hover:bg-red-100 transition-all group">
                            <span className="text-2xl mb-2 group-hover:scale-110 transition-transform">📉</span>
                            <span className="text-sm font-semibold">Stock Bajo</span>
                        </button>
                        <button className="flex flex-col items-center justify-center p-4 rounded-xl border border-orange-100 bg-orange-50 text-orange-700 hover:bg-orange-100 transition-all group">
                            <span className="text-2xl mb-2 group-hover:scale-110 transition-transform">⏰</span>
                ...
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col justify-center min-h-[250px] relative overflow-hidden">
                    {mostrarStock ? (
                        <div key="stock" className="animate-in fade-in slide-in-from-right-4 duration-700 text-center">
                            <span className="text-4xl mb-4 block">🚨</span>
                            <h4 className="text-lg font-bold text-gray-800">Alerta de Stock Bajo</h4>
                            <p className="text-gray-500 text-sm mb-4 italic">{productosBajoStock} productos por agotarse</p>
                            <Link to="/inventario" className="text-red-600 font-bold text-sm hover:underline">Revisar ahora →</Link>
                        </div>
                    ) : (
                        <div key="vence" className="animate-in fade-in slide-in-from-right-4 duration-700 text-center">
                            ...
                            <button
                                ...
                                onClick={() => setShowAlertModal(true)} // Opcional: abrir un detalle
                            >
                                Ver detalles →
                            </button>
                        </div>
